...
import { createTaskHandler, getTaskHandlers, getDueLocations } from '../../services/api';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <ul className="border p-4 rounded">
       ...
       <Link href="/dashboard/duelocations"
        className="bg-green-500 text-white px-4 py-2 rounded-md mt-9 inline-block hover:bg-green-800 transition"
      >
        View Due Locations
      </Link>
